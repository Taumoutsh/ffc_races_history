export const translations = {
  en: {
    ui: {
      ...
      unselectDefault: 'Unselect default cyclist',
    ...
    admin: {
      ...
      cannotModifyOwnPrivileges: 'Cannot modify your own privileges',
      cannotDeleteOwnAccount: 'Cannot delete your own account',
      confirmGrantAdmin: 'Are you sure you want to grant admin privileges to "{{username}}"?',
      confirmRevokeAdmin: 'Are you sure you want to revoke admin privileges from "{{username}}"?',
  ...
  fr: {
    ui: {
      ...
      unselectDefault: 'Désélectionner le cycliste par défaut',
    ...
    admin: {
      ...
      failedToUpdateAdminStatus: 'Échec de la mise à jour du statut administrateur',
      adminPrivilegesRequired: 'Privilèges administrateur requis',
      cannotModifyOwnStatus: 'Impossible de modifier votre propre statut',
      cannotModifyOwnPrivileges: 'Impossible de modifier vos propres privilèges',
      cannotDeleteOwnAccount: 'Impossible de supprimer votre propre compte',
      confirmGrantAdmin: 'Êtes-vous sûr de vouloir accorder les privilèges administrateur à "{{username}}" ?',
      confirmRevokeAdmin: 'Êtes-vous sûr de vouloir révoquer les privilèges administrateur de "{{username}}" ?',
