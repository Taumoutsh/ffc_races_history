export const translations = {
  en: {
    ui: {
      ...
      instructionPerformanceChart: 'Navigate through race history using the interactive performance chart',
      instructionChartNavigation: 'Use hover arrows (← →) to browse through paginated race results',
      instructionRaceDetails: 'Click any chart point to see complete race leaderboards with all participants',
      instructionCyclistProfiles: 'Access detailed cyclist information by clicking names in search results or leaderboards',
      instructionViewModes: 'Switch between chart and table views in cyclist profiles for different data perspectives',
      instructionComparison: 'Compare performance between cyclists using the comparison feature (⚔️ button)',
      instructionComparisonTable: 'Analyze head-to-head performance with sortable comparison tables including dates and positions',
      instructionDefaultCyclist: 'Set any cyclist as default (⭐ button) to highlight them throughout the app',
      instructionTopPercentage: 'View Top % rankings with color-coded performance indicators (green=best, red=worst)',
      instructionAutoAnalysis: 'Extract race data automatically by pasting URLs from paysdelaloirecyclisme.fr or velo.ffc.fr',
      instructionClearData: 'Use the clear button (🗑️) to reset auto-analysis inputs',
      instructionPDFExport: 'Export research results to PDF with clickable cyclist histories and organized layouts',
      instructionLanguage: 'Switch between English and French using the language toggle in the header',
      instructionMobileOptimized: 'Enjoy fully responsive design optimized for mobile devices with touch-friendly controls',
  ...
  fr: {
    ui: {
      ...
      instructionPerformanceChart: 'Naviguez dans l\'historique des courses avec le graphique de performance interactif',
      instructionChartNavigation: 'Utilisez les flèches au survol (← →) pour parcourir les résultats de courses paginés',
      instructionRaceDetails: 'Cliquez sur n\'importe quel point du graphique pour voir les classements complets avec tous les participants',
      instructionCyclistProfiles: 'Accédez aux informations détaillées des cyclistes en cliquant sur les noms dans les résultats ou classements',
      instructionViewModes: 'Basculez entre les vues graphique et tableau dans les profils de cyclistes pour différentes perspectives',
      instructionComparison: 'Comparez les performances entre cyclistes avec la fonction de comparaison (bouton ⚔️)',
      instructionComparisonTable: 'Analysez les performances face-à-face avec des tableaux de comparaison triables incluant dates et positions',
      instructionDefaultCyclist: 'Définissez n\'importe quel cycliste par défaut (bouton ⭐) pour le mettre en évidence dans toute l\'app',
      instructionTopPercentage: 'Consultez les classements Top % avec indicateurs de performance colorés (vert=meilleur, rouge=pire)',
      instructionAutoAnalysis: 'Extrayez automatiquement les données de course en collant des URLs de paysdelaloirecyclisme.fr ou velo.ffc.fr',
      instructionClearData: 'Utilisez le bouton effacer (🗑️) pour réinitialiser les entrées d\'auto-analyse',
      instructionPDFExport: 'Exportez les résultats de recherche en PDF avec historiques de cyclistes cliquables et mises en page organisées',
      instructionLanguage: 'Basculez entre anglais et français avec le sélecteur de langue dans l\'en-tête',
      instructionMobileOptimized: 'Profitez d\'un design entièrement responsive optimisé pour appareils mobiles avec contrôles tactiles',
